            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex border border-gray-300 rounded-lg overflow-hidden">
                    {/* === SỬA LẠI ĐÂY === */}
                    <input type="text" className="px-4 py-2 text-sm outline-none flex-1 focus:ring-2 focus:ring-blue-500" placeholder={roleFilter === 'Parent' ? "Tìm theo username hoặc SĐT..." : "Tìm theo username..."} value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
